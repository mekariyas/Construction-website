...
const NavBar = () => {
  ...
  return (
    <header className={`w-full  flex  items-center pl-4 pr-4 justify-between h-24 sticky top-0 z-[4] bg-transparent backdrop-blur-lg backdrop-brightness-50`}>
            ...
            <nav className={`w-full absolute z-[4] top-[94px] right-0 h-[80vh] md:w-[60%] md:static md:h-16 ${visible ? 'flex' : 'hidden'} md:flex flex-col md:flex-row justify-around items-center space-y-4 md:space-y-0 bg-slate-700 text-white bg-opacity-70 backdrop-blur-lg backdrop-brightness-50 md:bg-transparent md:bg-none   md:text-black md:backdrop-blur-none`}>
